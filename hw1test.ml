...
let subset_test4 = subset [3;1] [1;3]
let subset_test5 = not (subset [4] [])


let equal_sets_test0 = equal_sets [1;3] [3;1;3]
let equal_sets_test1 = not (equal_sets [1;3;4] [3;1;3])
let equal_sets_test2 = equal_sets [1,2;3,4;] [3,4;1,2;]
let equal_sets_test3 = equal_sets [] []
...
let set_union_test3 = equal_sets (set_union [3,4;1,2;] [2,1;4,3;]) [1,2;3,4;4,3;2,1;]
let set_union_test3 = equal_sets (set_union [1;1;1;] [2;2]) [1;2]
...
let set_intersection_test3 =
     equal_sets (set_intersection ["a";"b";"c";] ["a";"d";"c";]) ["a";"c";] 
let set_intersection_test4 =
    equal_sets (set_intersection ["a";"a";"b";] ["a";"a";"b"]) ["a";"b";]
...
let set_diff_test4 = equal_sets (set_diff ["a";"b";"c"] ["d"]) ["a";"b";"c"]
...
let computed_fixed_point_test4 =
    computed_fixed_point (=) (fun x -> 4) 1000 = 4
...
let computed_periodic_point_test2 =
      computed_periodic_point (=) (fun x -> x * -1) 2 10 = 10
...
let giant_test3 = 
    filter_blind_alleys(Sentence, [Snore, [T"ZZZ"];
                                  Quiet, [];
                                  Grunt, [T"ayy lmao";N Shout;];
                                  Shout, [N Shout;]]) = (Sentence, [Snore, [T"ZZZ"];
                                                         Quiet, [];])
